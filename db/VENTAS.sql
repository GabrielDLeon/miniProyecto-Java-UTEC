...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ROL_FUNC_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 24 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ROL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ROL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 25 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
Insert into FUNCIONALIDAD (ID_FUNCIONALIDAD,NOMBRE,DESCRIPCION) values ('2','Ventas','Ventas son las actividades realizadas para incentivar potenciales clientes a realizar una determinada compra.');
...
Insert into ROL (ID_ROL,NOMBRE,DESCRIPCION,TIPO) values ('5','AGUATERO','TE LLEVA EL AGUA','OPERADOR_SECCION');
...
Insert into ROL_FUNCION (ID_ROL_FUNCION,ID_ROL,ID_FUNCION) values ('4','5','2');
Insert into ROL_FUNCION (ID_ROL_FUNCION,ID_ROL,ID_FUNCION) values ('5','5','3');
--------------------------------------------------------
